...
// For video agent workflow, category is used instead of sisyphus-junior
...
export async function resolveSubagentExecution(
  ...
  if (agentName.toLowerCase() === CATEGORY_AGENT.toLowerCase()) {
    return {
      agentToUse: "",
      categoryModel: undefined,
      error: `Cannot use subagent_type="${CATEGORY_AGENT}" directly. Use category parameter instead (e.g., ${categoryExamples}).`,
    }
  }
